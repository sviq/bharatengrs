          ...
          {features.map((item, i) => {
            ...
            return (
              ...
              >
                {/* ICON BOX */}
                <div
                  className="w-12 h-12 bg-[#050f47] text-white rounded-lg flex items-center justify-center mb-6 
                ...
                {/* TITLE */}
                <h4 className="text-xl font-bold text-[#050f47] mb-3 group-hover:text-orange-500">
                  {item.title}
                </h4>
